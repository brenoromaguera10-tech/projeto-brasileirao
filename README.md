...
## Régua de confiança
- 1x2: ALTA (nível de mercado)  - BTTS/Over: MÉDIA
- Chutes/Escanteios: MÉDIA (médias por time)  - Cartões: MÉDIA-BAIXA (árbitro+faltas)

## Limites conhecidos (v1)
- Chutes: só taxa "a favor" (falta shots-against).
- Estatísticas são médias de temporada, não modelo jogo-a-jogo.
- Melhor upgrade: CSV de estatísticas por partida.
